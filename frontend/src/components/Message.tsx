            ...
            <div className={`mt-3 flex ${isOwn ? "justify-end" : "justify-start"}`}>
                <div className="flex gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        { message?.type === "CALL" && (
                             <VideoCallMessage isOwn ={isOwn}></VideoCallMessage>
                        )}
...
const VideoCallMessage = ({ isOwn }: { isOwn: boolean }) => {
  return (
    <>
      {/* Dialog Trigger */}
      <Dialog>
        <DialogTrigger asChild>
          <div
            className={`flex items-center px-4 py-2 mt-2 rounded-lg text-sm cursor-pointer ${
              isOwn
        ...
        <DialogContent className="sm:max-w-sm bg-white">
          <DialogHeader>
            ...
            <DialogDescription>Join John Doe's video call?</DialogDescription>
          </DialogHeader>
